...
### 图片（直接可用）
```
Raw:    https://raw.githubusercontent.com/<USER>/vibe-assets/main/assets/products/uv-varnish/hero.jpg
CDN:    https://cdn.jsdelivr.net/gh/<USER>/vibe-assets@main/assets/products/uv-varnish/hero.jpg
```

### 视频（建站/剪辑用）
```
Raw:    https://raw.githubusercontent.com/<USER>/vibe-assets/main/assets/factory/line-01.mp4
CDN:    https://cdn.jsdelivr.net/gh/<USER>/vibe-assets@main/assets/factory/line-01.mp4
```

### 在 HTML/代码中引用
```html
<img src="https://cdn.jsdelivr.net/gh/USER/vibe-assets@main/assets/products/uv-varnish/hero.jpg">
<video src="https://raw.githubusercontent.com/USER/vibe-assets/main/assets/factory/line-01.mp4"></video>
```
...
```json
{
  ...
  "base_url_raw": "https://raw.githubusercontent.com/USER/vibe-assets/main",
  "base_url_cdn": "https://cdn.jsdelivr.net/gh/USER/vibe-assets@main",
  "assets": [
    {
      "id": "uv-varnish-hero",
